...
for( let i = 0; i < picArray.length; i++ ) {
  ...
  let header = document.createTextNode(picArray[i].title);
  ...
  let caption = document.createTextNode(picArray[i].caption);
  figcaption.appendChild(caption);
  figure.appendChild(figcaption);

  let p = document.createElement('p');
  let text = document.createTextNode(picArray[i].description);
  p.appendChild(text)
